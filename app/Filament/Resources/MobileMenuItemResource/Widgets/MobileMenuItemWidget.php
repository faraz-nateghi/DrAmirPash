...
namespace App\Filament\Resources\MobileMenuItemResource\Widgets;
...
class MobileMenuItemWidget extends BaseWidget
{
    protected static string $model = MobileMenuItem::class;

    protected static int $maxDepth = 2;

    protected ?string $treeTitle = 'MobileMenuItemWidget';
